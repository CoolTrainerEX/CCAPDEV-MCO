...
export const getReadLabUrl = (id: string,) => {
...
export const readLab = async (id: string, options?: RequestInit): Promise<readLabResponse> => {
...
export const getReadLabQueryKey = (id: string,) => {
    return [
    `/api/lab/${id}`
    ] as const;
    }
...
export const getReadLabQueryOptions = <TData = Awaited<ReturnType<typeof readLab>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof readLab>>, TError, TData>>, fetch?: RequestInit}
) => {
...
export function useReadLab<TData = Awaited<ReturnType<typeof readLab>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(
 id: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof readLab>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useReadLab<TData = Awaited<ReturnType<typeof readLab>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(
 id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof readLab>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Read a lab
...
export const getUpdateLabMutationOptions = <TError = BadRequestResponse | UnauthorizedResponse | NotFoundResponse | UnexpectedResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateLab>>, TError,{id: string;data: LabDetails}, TContext>, fetch?: RequestInit}
): UseMutationOptions<Awaited<ReturnType<typeof updateLab>>, TError,{id: string;data: LabDetails}, TContext> => {
...
const {mutation: mutationOptions, fetch: fetchOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateLab>>, {id: string;data: LabDetails}> = (props) => {
          const {id,data} = props ?? {};
...
export const deleteLab = async (id: string, options?: RequestInit): Promise<deleteLabResponse> => {
...
export const getDeleteLabMutationOptions = <TError = BadRequestResponse | UnauthorizedResponse | NotFoundResponse | UnexpectedResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteLab>>, TError,{id: string}, TContext>, fetch?: RequestInit}
