...
export const ReadLabsResponse = zod.object({
  ...
  "id": zod.number().min(readLabsResponseDataItemOneSlotsItemIdMin),
  ...
  "id": zod.number().min(readLabsResponseDataItemTwoIdMin),
...
export const ReadLabParams = zod.object({
  "id": zod.coerce.number().min(readLabPathIdMin).describe('The unique identifier of the lab')
})
...
export const UpdateLabParams = zod.object({
  "id": zod.coerce.number().min(updateLabPathIdMin).describe('The unique identifier of the lab')
})
...
export const DeleteLabParams = zod.object({
  "id": zod.coerce.number().min(deleteLabPathIdMin).describe('The unique identifier of the lab')
})
