...
export type createReservationResponseError = (createReservationResponse400 | createReservationResponse401 | createReservationResponse404 | createReservationResponse409 | createReservationResponse500) & {
  headers: Headers;
};
...
export const createReservation = async (reservationDetails: ReservationDetails, options?: RequestInit): Promise<createReservationResponse> => {
...
export const getCreateReservationMutationOptions = <TError = BadRequestResponse | UnauthorizedResponse | NotFoundResponse | ExistsResponse | UnexpectedResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createReservation>>, TError,{data: ReservationDetails}, TContext>, fetch?: RequestInit}
): UseMutationOptions<Awaited<ReturnType<typeof createReservation>>, TError,{data: ReservationDetails}, TContext> => {
...
const {mutation: mutationOptions, fetch: fetchOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createReservation>>, {data: ReservationDetails}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateReservationMutationError = BadRequestResponse | UnauthorizedResponse | NotFoundResponse | ExistsResponse | UnexpectedResponse

    /**
 * @summary Create a reservation
 */
export const useCreateReservation = <TError = BadRequestResponse | UnauthorizedResponse | NotFoundResponse | ExistsResponse | UnexpectedResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createReservation>>, TError,{data: ReservationDetails}, TContext>, fetch?: RequestInit}
...
export const getReadReservationUserUrl = (id: string,) => {
...
export const readReservationUser = async (id: string, options?: RequestInit): Promise<readReservationUserResponse> => {
...
export const getReadReservationUserQueryKey = (id: string,) => {
    return [
...
export const getReadReservationUserQueryOptions = <TData = Awaited<ReturnType<typeof readReservationUser>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof readReservationUser>>, TError, TData>>, fetch?: RequestInit}
) => {
...
export function useReadReservationUser<TData = Awaited<ReturnType<typeof readReservationUser>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(
 id: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof readReservationUser>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useReadReservationUser<TData = Awaited<ReturnType<typeof readReservationUser>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(
 id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof readReservationUser>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Read the reservations of the user
...
export const getReadReservationLabUrl = (id: string,) => {
...
export const readReservationLab = async (id: string, options?: RequestInit): Promise<readReservationLabResponse> => {
...
export const getReadReservationLabQueryKey = (id: string,) => {
    return [
...
export const getReadReservationLabQueryOptions = <TData = Awaited<ReturnType<typeof readReservationLab>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof readReservationLab>>, TError, TData>>, fetch?: RequestInit}
) => {
...
export function useReadReservationLab<TData = Awaited<ReturnType<typeof readReservationLab>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(
 id: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof readReservationLab>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useReadReservationLab<TData = Awaited<ReturnType<typeof readReservationLab>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(
 id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof readReservationLab>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Read the reservations of the lab
