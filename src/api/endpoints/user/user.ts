...
export const getReadUserUrl = (id: string,) => {
...
export const readUser = async (id: string, options?: RequestInit): Promise<readUserResponse> => {
...
export const getReadUserQueryKey = (id: string,) => {
    return [
    `/api/user/${id}`
    ] as const;
    }
...
export const getReadUserQueryOptions = <TData = Awaited<ReturnType<typeof readUser>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof readUser>>, TError, TData>>, fetch?: RequestInit}
) => {
...
export function useReadUser<TData = Awaited<ReturnType<typeof readUser>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(
 id: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof readUser>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useReadUser<TData = Awaited<ReturnType<typeof readUser>>, TError = BadRequestResponse | NotFoundResponse | UnexpectedResponse>(
 id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof readUser>>, TError, TData>>, fetch?: RequestInit}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Read a user
