...
export type readCurrentUserResponseError = (
  | readCurrentUserResponse401
  | readCurrentUserResponse404
  | readCurrentUserResponse500
) & {
  headers: Headers;
};

export type readCurrentUserResponse =
  | readCurrentUserResponseSuccess
  | readCurrentUserResponseError;
...
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof readCurrentUser>>, TError, TData>
  >;
  fetch?: RequestInit;
}) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof readCurrentUser>>> = ({
    signal,
  }) => readCurrentUser({ signal, ...fetchOptions });
...
export type ReadCurrentUserQueryResult = NonNullable<
  Awaited<ReturnType<typeof readCurrentUser>>
>;
export type ReadCurrentUserQueryError =
  | UnauthorizedResponse
  | NotFoundResponse
  | UnexpectedResponse;
