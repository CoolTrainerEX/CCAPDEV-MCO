...
export const reservations: Reservation[] = [
  {
    ...
    labId: 1,
    schedule: {
      start: parse("07:30", "HH:mm", new Date()).toISOString(),
      end: parse("17:00", "HH:mm", new Date()).toISOString(),
    },
    slotIds: [1, 2, 3],
  },
  {
    ...
    anonymous: true,
    schedule: {
      start: parse("16:00", "HH:mm", new Date()).toISOString(),
      end: parse("18:00", "HH:mm", new Date()).toISOString(),
    },
  ...
  },
  {
    ...
    labId: 1,
    schedule: {
      start: parse("9:00", "HH:mm", new Date()).toISOString(),
      end: parse("14:00", "HH:mm", new Date()).toISOString(),
    },
    slotIds: [5, 6, 7],
  },
  {
    ...
    schedule: {
      start: parse("07:30", "HH:mm", new Date()).toISOString(),
      end: parse("14:30", "HH:mm", new Date()).toISOString(),
    },
    slotIds: [4, 5, 6, 7],
  },
  {
    ...
    labId: 2,
    schedule: {
      start: parse("12:00", "HH:mm", new Date()).toISOString(),
      end: parse("17:30", "HH:mm", new Date()).toISOString(),
    },
    slotIds: [14, 15, 17, 18],
  },
];
